...
IOBase *IOFactory::CreateIO(std::string type, Params &params, int io_type, string scriptDemoValue)
{
    IOBase *obj = nullptr;
    ...
    if (!obj)
    {
        ...
        obj = new IOBase(params, "unknown", TSTRING, io_type, scriptDemoValue);
    }
