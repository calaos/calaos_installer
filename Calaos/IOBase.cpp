...
REGISTER_INPUT(WebInputSwitch, "switch", TBOOL)
...
REGISTER_INPUT(ZibaseTemp, "temp", TINT)
REGISTER_INPUT(ZibaseAnalogIn, "analog_in", TINT)
REGISTER_INPUT(ZibaseDigitalIn, "switch", TBOOL)
REGISTER_INPUT(MySensorsInputAnalog, "analog_in", TINT)
REGISTER_INPUT(MySensorsInputString, "string_in", TSTRING)
REGISTER_INPUT(MySensorsInputSwitch, "switch", TBOOL)
...
REGISTER_INPUT(KNXInputSwitch, "switch", TBOOL)
REGISTER_INPUT(KNXInputAnalog, "analog_in", TINT)
REGISTER_INPUT(KNXInputSwitchLongPress, "switch_long", TINT)
REGISTER_INPUT(KNXInputSwitchTriple, "switch3", TINT)
REGISTER_INPUT(KNXInputTemp, "temp", TINT)
...
REGISTER_OUTPUT(MySensorsOutputAnalog, "analog_out", TINT)
REGISTER_OUTPUT(MySensorsOutputDimmer, "light_dimmer", TSTRING)
REGISTER_OUTPUT(MySensorsOutputLight, "light", TBOOL)
REGISTER_OUTPUT(MySensorsOutputLightRGB, "light_rgb", TSTRING)
...
REGISTER_OUTPUT(WOLOutputBool, "var_bool", TBOOL)
REGISTER_OUTPUT(KNXOutputLight, "light", TBOOL)
REGISTER_OUTPUT(KNXOutputAnalog, "analog_out", TBOOL)
REGISTER_OUTPUT(KNXOutputLightDimmer, "light_dimmer", TSTRING)
